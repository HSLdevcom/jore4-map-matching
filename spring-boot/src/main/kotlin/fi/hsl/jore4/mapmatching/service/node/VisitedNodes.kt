...
data class VisitNodesOnMultipleLinks(val nodesToVisitOnStartLink: VisitedNodesOnLink,
...
data class VisitNodesOfSingleLinkUnidirectionally(val startNodeId: InfrastructureNodeId,
...
data class VisitNodesOfSingleLinkBidirectionally(val firstNodeId: InfrastructureNodeId,
    ...
    override fun toListOfNodeIdSequences(): List<NodeIdSequence> {
        return listOf(NodeIdSequence(listOf(firstNodeId, secondNodeId)),
