...
import fi.hsl.jore4.mapmatching.util.GeolatteUtils.mergeContinuosLines
...
object RoutingServiceHelper {
    ...
    internal fun transformToResponse(routeSegments: List<RouteSegmentDTO>,
        ...
        try {
            mergedLine = mergeContinuosLines(segmentGeometries)
        } catch (ex: Exception) {
        ...
        val route = RouteResultDTO(mergedLine, totalCost, totalCost, stops)
