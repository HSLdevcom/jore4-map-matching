 ...
 *
 * @property pointOnLink a snapped point on infrastructure link at either end of route
 * @property terminusStopPointMatchFoundByNationalId indicates whether the infrastructure link ID of
 * [pointOnLink] is the same as is associated with the public transport stop point matched by
 * a national ID obtained from a map-matching request.
 */
data class TerminusLinkCandidate(val pointOnLink: SnappedPointOnLink,
