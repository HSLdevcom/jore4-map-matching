...
data class RouteStopPoint(override val location: Point<G2D>,
                          val projectedLocation: Point<G2D>?,
                          @field:Pattern(regexp = "[\\w\\d-_ ]{1,10}") val passengerId: String,
                          val nationalId: Int?) : RoutePoint

data class RouteJunctionPoint(override val location: Point<G2D>) : RoutePoint
data class RouteOtherPoint(override val location: Point<G2D>) : RoutePoint
