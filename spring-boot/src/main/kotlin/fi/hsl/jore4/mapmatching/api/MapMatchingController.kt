...
class MapMatchingController @Autowired constructor(val matchingService: IMatchingService) {

    @PostMapping("/$TRANSPORTATION_MODE_PARAM",
                 "/$TRANSPORTATION_MODE_PARAM.json")
    fun findMatchForPublicTransportRoute(@PathVariable transportationMode: String,
    ...
    @PostMapping("/$TRANSPORTATION_MODE_PARAM/$VEHICLE_TYPE_PARAM",
