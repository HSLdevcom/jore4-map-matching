            ...
            linkRecordById[linkId]?.let { linkRecord: InfrastructureLinkRecord ->
                ...
                val stopPointFractionalMeasureOnLink: Double? = when {
                    ...
                    stopDistFromStart <= linkLength -> stopDistFromStart / linkLength
                        ...
                        LOGGER.warn(
                            "Distance of public transport stop (ID={}) from the start of the infrastructure link it " +
                                "is located along is greater than the length of the link (ID={}): {} > {}. " +
                                "Calculated fractional measure manually: {}",
