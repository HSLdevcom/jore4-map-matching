...
@Service
class MatchingServiceImpl @Autowired constructor(val viaPointsOnLinksService: IMatchRouteViaPointsOnLinksService,
                                                 val viaNodesService: IMatchRouteViaNetworkNodesService)
    : IMatchingService {

    @Transactional(readOnly = true)
    override fun findMatchForPublicTransportRoute(sourceRouteId: String?,
        ...
        val viaPointsOnLinksResponse: RoutingResponse = viaPointsOnLinksService
            .findMatchForPublicTransportRoute(sourceRouteGeometry,
                                              sourceRoutePoints,
                                              vehicleType,
                                              matchingParameters)
            ...
            is RoutingResponse.RoutingFailureDTO -> {
                ...
                when (matchingParameters.fallbackToViaNodesAlgorithm) {
                    false -> viaPointsOnLinksResponse
                        ...
                        val viaNodesResponse: RoutingResponse = viaNodesService
                            .findMatchForPublicTransportRoute(sourceRouteGeometry,
                                                              sourceRoutePoints,
                                                              vehicleType,
                                                              matchingParameters)
