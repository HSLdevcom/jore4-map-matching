...
@InternalService
class MatchRouteViaNetworkNodesServiceImpl
    @Autowired
    constructor(
        ...
        override fun findMatchForPublicTransportRoute(
            ...
            val nodeSequenceCandidates: List<NodeSequenceCandidatesBetweenSnappedLinks> =
                try {
                    resolveNodeSequenceCandidates(
                        sourceRoutePoints,
                        vehicleType,
            ...
            val nodeSeqResult: NodeSequenceResolutionResult =
                nodeService.resolveNodeIdSequence(
         ...
         */
        internal fun resolveNodeSequenceCandidates(
            sourceRoutePoints: List<RoutePoint>,
            vehicleType: VehicleType,
            ...
            val viaNodeHolders: List<Either<SnappedPointOnLink, NodeProximity>> =
                sourceRoutePoints
                    .withIndex()
                    .drop(1)
                    .dropLast(1)
