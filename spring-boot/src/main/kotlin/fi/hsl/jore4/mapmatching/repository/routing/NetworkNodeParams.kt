...
data class NetworkNodeParams(val firstLinkEndpointIds: Pair<Int, Int>,
                             val lastLinkEndPointIds: Pair<Int, Int>,
                             val interimNodeIds: List<Int>) {

    internal fun getNodeSequenceVariants(): NetworkNodeSequences {
        val listOfSequences: List<List<Int>> = firstLinkEndpointIds.toList()
            .flatMap { startNodeId ->
                lastLinkEndPointIds
                    .toList()
                    .map { endNodeId ->
