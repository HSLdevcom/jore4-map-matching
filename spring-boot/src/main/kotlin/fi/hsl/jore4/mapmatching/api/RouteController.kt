...
import fi.hsl.jore4.mapmatching.service.routing.RoutingService
...
class RouteController @Autowired constructor(val routingService: RoutingService) {

    @GetMapping("/driving/{coords}")
    ...
    companion object {
        ...
        private const val DEFAULT_LINK_SEARCH_RADIUS = 300
