...
class RoutingRepositoryImpl @Autowired constructor(val jdbcTemplate: NamedParameterJdbcTemplate,
    ...
    override fun findRouteViaPointsOnLinks(points: List<PgRoutingPoint>,
        ...
        // state for previously added virtual node, used for comparison while adding new virtual nodes
    ...
    companion object {
         ...
         * virtual nodes, the infrastructure links along which those virtual nodes are located,
