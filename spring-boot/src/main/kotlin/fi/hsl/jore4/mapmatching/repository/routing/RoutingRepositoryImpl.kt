        ...
        points.forEach { point ->
            when (point) {
                ...
                is FractionalLocationAlongLink -> {
                    ...
                    // According to pgRouting documentation, a fractional point on infrastructure
                    // link is referenced by a negative ID value. In addition, it is needed to
                    // avoid values [-2, -1] while assigning IDs because that range may have
                    // special semantics in pgRouting output.
