...
class RoutingRepositoryImpl @Autowired constructor(val jdbcTemplate: NamedParameterJdbcTemplate,
    ...
    override fun findRouteViaPoints(points: List<PgRoutingPoint>,
            ...
            when (point) {
                ...
                is FractionalLocationAlongLink -> {
                    ...
                    if (fraction.isWithinTolerance(0.0, roundingTolerance)
                        ...
                        // Snap to endpoint node if rounded value of fractional location is zero or one.
                        ...
                        fun addCustomPoint() {
                            ...
                            // According to pgRouting documentation, a fractional point on
                            // infrastructure link is referenced by a negative ID value.
                            // In addition, it is needed to avoid values [-2, -1] while assigning
                            // IDs because that range may have special semantics in pgRouting
                            // output.
        ...
        // There could be consecutive duplicates of infrastructure node IDs because of snapping to
        // link endpoints.
    ...
    companion object {
         ...
         * (1) ID of infrastructure link along which the point is located,
