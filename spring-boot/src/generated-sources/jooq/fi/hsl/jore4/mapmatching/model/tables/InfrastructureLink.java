...
public class InfrastructureLink extends TableImpl<InfrastructureLinkRecord> {
     ...
     */
    public final TableField<InfrastructureLinkRecord, LineString> GEOM = createField(DSL.name("geom"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"extensions\".\"geometry\"").nullable(false), this, "The 2D linestring geometry describing the shape of the infrastructure link. The requirement of two-dimensionality and metric unit is imposed by pgRouting. The EPSG:3067 coordinate system applied is the same as is used in Digiroad.", new LineStringBinding());
