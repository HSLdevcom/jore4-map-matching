...
interface IRoadJunctionMatcher {
     ...
     * a road junction type are attempted to be matched with infrastructure
     * nodes. The matched nodes are indexed in the same order as the route
     * points exist in [routePoints], i.e. there may be gaps between the index
     * numbers found as keys of the result [Map].
     *
     ...
     * node for such an infrastructure link that is safely traversable by the
     * given vehicle type.
