...
class RoutingRepositoryImpl(
    ...
    override fun findRouteViaNetworkNodes(
        nodeIdSequence: NodeIdSequence,
        vehicleType: VehicleType,
        bufferAreaRestriction: BufferAreaRestriction?
    ): List<RouteLink> =
        findRouteViaNetworkNodesInternal(nodeIdSequence, vehicleType, null, null, bufferAreaRestriction)
    ...
    override fun findRouteViaNetworkNodes(
        ...
        findRouteViaNetworkNodesInternal(
            nodeIdSequence,
            vehicleType,
    ...
    fun findRouteViaNetworkNodesInternal(
        nodeIdSequence: NodeIdSequence,
        vehicleType: VehicleType,
        fractionalStartLocationOnFirstLink: Double?,
        fractionalEndLocationOnLastLink: Double?,
    ...
    override fun findRouteViaPointsOnLinks(
            ...
            when (point) {
                ...
                is VirtualNode -> {
                    ...
                    if (fraction.isWithinTolerance(0.0, roundingTolerance) ||
                        ...
                        val roundedFraction: Double =
                            (fraction * roundingMultiplier).roundToInt() / roundingMultiplier
                        ...
                        if (prevVirtualNodeLinkId == null || prevVirtualNodeRoundedFraction == null) {
                            ...
                            val isPointAConsecutiveDuplicateAfterRounding: Boolean =
                                linkId == prevVirtualNodeLinkId &&
                                    roundedFraction.isWithinTolerance(
                                        prevVirtualNodeRoundedFraction!!,
                                        roundingTolerance
                                    )
        ...
        val parameterSetter =
            PreparedStatementSetter { pstmt ->
                ...
                pstmt.setArray(
                    paramIndex++,
                    pstmt.connection.createArrayOf("bigint", linkIdsForVirtualNodes.toTypedArray())
                )
                pstmt.setArray(
                    paramIndex++,
                    pstmt.connection.createArrayOf("numeric", fractionalLocations.toTypedArray())
                )
                pstmt.setArray(paramIndex++, pstmt.connection.createArrayOf("char", linkSides.toTypedArray()))

                pstmt.setArray(
                    paramIndex++,
                    pstmt.connection.createArrayOf("bigint", filteredPointsIds.toTypedArray())
                )
        ...
        val queryString: String =
            getQueryForFindingRouteViaPoints(
                roundedFractionDecimalPrecision,
                bufferAreaRestriction
            )
    ...
    private fun setParametersForBufferAreaRestriction(
    ...
    private fun executeQueryAndTransformToResult(
        queryString: String,
        parameterSetter: PreparedStatementSetter
    ): List<RouteLink> {
        ...
        val queryResults: List<ResultItem> =
                ...
                .mapNotNull { path ->
                    when (path) {
                        ...
                        is RouteLinkResultItem -> {
                            ...
                            val trimmedRouteLink: TrimmedRouteLinkResultItem? =
                                routeSeqNumToTrimmedRouteLink[seqNum]
    ...
    companion object {
         ...
         *    5 | 238707 | t                     |            0.0 |         0.66
         */
        private fun getQueryForFindingRouteViaPoints(
            roundedFractionDecimalPrecision: Int,
            bufferAreaRestriction: BufferAreaRestriction?
        ) = """
