...
data class PublicTransportRouteMatchRequestDTO(
    ...
    /**
     * Contains parameters that can be adjusted to get optimal results in
     * matching public transport routes against the infrastructure network
     ...
     * case a terminus link cannot be determined via matching public transport
     ...
     * nodes at this distance from the route point to have a match with high
