...
Alternatively, in order to avoid rebuilding Docker image every the code is changed, one can launch database dependencies via docker-compose and start the application locally (not inside a Docker container) as follows:
